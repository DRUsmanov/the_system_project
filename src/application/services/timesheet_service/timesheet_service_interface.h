...
public:
    ...
    virtual std::optional<domain::Timesheet> getTimesheet(domain::DepartmentId department_id,
    ...
    virtual bool generateTimesheetForNewEmployee(domain::DepartmentId department_id,
